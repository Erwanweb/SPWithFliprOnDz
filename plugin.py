...
<plugin key="SPWithFliprOnDzByEMA" name="ZZ - Swimming Pool Control with Flipr analyzer" author="EMA Team" version="1.1.2" externallink="https://github.com/Erwanweb/SPWithFliprOnDz">
    <params>
        ...
        <param field="Mode2" label="Setting (csv list)" width="200px" width="200px" required="false" default="60,0,60,120,0"/>
...
# Heartbeat  ---------------------------------------------------
    ...
    def onHeartbeat(self):
        ...
        if self.FliprVarNextRefresh <= now:
            ...
            self.Internals['FliprTemp'] = self.RedoxValNet
        ...
        # be sure each 15 mins relay take the real good order and position
