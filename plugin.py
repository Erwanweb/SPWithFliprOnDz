...
<plugin key="SPWithFlipr" name="ZZ - Swimming Pool Control with Flipr analyzer" author="Ronelabs Team" version="0.1.5" externallink="https://github.com/Erwanweb/SPWithFlipronDZ">
    <description>
    ...
    <params>
        <param field="Address" label="Flipr account Email" width="400px" required="true" default=""/>
        <param field="Port" label="Flipr account Psw" width="400px" required="true" default=""/>
        <param field="Username" label="Flipr module ID" width="400px" required="true" default=""/>
        ...
        <param field="Mode3" label="Actuators (0 for not): Pump, Heater, PH-, Chlor. (csv list of idx)" width="100px" required="true" default=""/>
        <param field="Mode4" label="Outdoor temperature (csv list of idx)" width="200px" required="false" default=""/>
...
class BasePlugin:
    ...
    def onStart(self):
        ...
        self.email = Parameters["SerialPort"]
        self.password = Parameters["Address"]
        self.module_id = Parameters["Port"]
        self.loginFlipr()
...
# Read Flipr Analyzer---------------------------------------------------------------------------------------------
    ...
    def readAnalyzer(self):
        ...
        if not self.pumpon :
            ...
            self.SPTempCheck = round(float(self.SPtemptemp))
            Devices[4].Update(nValue=0, sValue=str(self.SPTemp))
