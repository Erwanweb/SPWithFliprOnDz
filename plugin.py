...
<plugin key="SPControl" name="ZZ - Swimming Pool Control with Flipr analyzer" author="Ronelabs Team" version="0.1.1" externallink="https://github.com/Erwanweb/SPControl">
    <description>
    ...
    <params>
        <param field="SerialPort" label="Flipr account email" width="400px" required="true" default=""/>
        <param field="Address" label="Flipr account Psw" width="400px" required="true" default=""/>
        <param field="Port" label="Flipr module ID" width="400px" required="true" default=""/>
