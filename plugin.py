...
class BasePlugin:
    ...
    def onCommand(self, Unit, Command, Level, Color):
        ...
        if (Unit == 15):
            Devices[15].Update(nValue=1, sValue=str(Level))
...
# Alexa  ---------------------------------------------------
    ...
    def verifSP(self):
        AlexaAPI("La piscine est a {} degré, son P-H est {} avec une valeur de {}, le niveau de desinfectant est {} ".format(self.SPTemp, self.PHText, self.PHValNet, self.RedoxText))
        Devices[15].Update(nValue=0, sValue=str(Level))
