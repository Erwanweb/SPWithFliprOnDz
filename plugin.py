...
# Heartbeat  ---------------------------------------------------
    ...
    def onHeartbeat(self):
        ...
        # datetime(year, month, day, hour, minute, second, microsecond)
           ...
           self.SunAtSouth = datetime(year=now.strftime("%Y"), month=now.strftime("%m"), day=now.strftime("%d"), hour=int(jsonData['SunAtSouth'].split(':')[0]), minute=int(jsonData['SunAtSouth'].split(':')[1]), second=0)
