...
<plugin key="SPControl" name="ZZ - Swimming Pool Control with Flipr analyzer" author="Ronelabs Team" version="0.1.5" externallink="https://github.com/Erwanweb/SPWithFliprOnDz">
    <description>
