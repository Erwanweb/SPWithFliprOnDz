...
#oauth2data = {'grant_type=password&username='username'&password='password'}
...
class BasePlugin:
    ...
    def __init__(self):
        ...
        self.SunAtSouth = datetime.time(13,0,0)
        self.startpump = datetime.time(7,0,0)
        self.stoppump = datetime.time(21,0,0)
        return
...
# Heartbeat  ---------------------------------------------------
    ...
    def onHeartbeat(self):
        ...
        if jsonData :
            self.SunAtSouth = datetime.time(hour=int(jsonData['SunAtSouth'].split(':')[0]),minute=int(jsonData['SunAtSouth'].split(':')[1]),second=0)
